...
*/
export function executeCircuit(circuit, initial_witness, _foreign_call_handler) {
    const ptr0 = passArray8ToWasm0(circuit, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_new_363b26ac9c8d1821 = function() {
        const ret = new Map();
        return addHeapObject(ret);
    };
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('acvm_simulator_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
